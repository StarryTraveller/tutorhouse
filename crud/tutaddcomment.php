...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if ($result) {
    ...
    header("Location: ../lms/teacher/tutcomments.php");
    exit;
  } else {
...
<DOCTYPE !html>
  ...
  <head>
    ...
    <title> Teacher | Add Comment </title>
    ...
    <div class="wrapper d-flex">
      <div class="sidebar">
        ...
        <ul>
          ...
          <li><a href="../crud/tutaddcomment.php"><i class="fas fa-code"></i>Comments</a></li>
        </ul>
      </div>

      <div class="main-content">
        <h2><center>New Comment</center></h2>
          <form action="./tutaddcomment.php" method="POST">
