...
$sql = "SELECT id, title, description, subject, level, file_path FROM assessments";
  ...
  <div class="container-wrapper">
    ...
    <div class="content">
      ...
      <h1> Assessments </h1>
        ...
        <a href="uploadassess.php" class="btn btn-primary">Upload Assessment</a>
        </div> <br>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="assess-card">
                    ...
                    <a href="<?php echo $assessFilePath; ?>" download class="assess-download-btn">Download</a>
                    <a href="../../crud/editassess.php?id=<?php echo $assessId; ?>" class="btn btn-primary">Edit</a>
                    <form method="post" action="../../crud/deleteassessment.php" onsubmit="return confirm('Are you sure you want to delete this record?')">
                        <input type="hidden" name="assessments" value="assessments"> <!-- Use the correct table name here -->
                        <input type="hidden" name="record_id" value="<?php echo $assessId; ?>">
                        <button type="submit" name="delete" class="btn btn-danger">Delete</button>
                        <a href="./submissionbinassess.php?assess_id=<?php echo $assessId; ?>" class="btn btn-primary">View Submits</a>
                      </form>
                </div>
                <?php
            }
