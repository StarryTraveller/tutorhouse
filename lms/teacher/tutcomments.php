...
if (isset($_GET['lastname']) && isset($_GET['firstname'])) {
    ...
    // Fetch comments based on the student's last name
    $commentsQuery = "SELECT * FROM comments WHERE name = '$lastname' ORDER BY created_at DESC";
...
<head>
  ...
  <title>Teacher | Tutor's Comments</title>
</head>
    ...
    <div class="content">
      <div class="main-content">
        <div class="activity-upload-btn">
          <h1> Comments </h1>
        <a href="../../crud/tutaddcomment.php" class="btn btn-primary">Add Comment</a>
        <br>
          ...
          if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo '   <tr>
                ...
                <td>' . $lastname . '</td>
                <td>' . $email . '</td>
                <td><button class="btn btn-primary"><a href="./studcomment.php?lastname=' . urlencode($lastname) . '&firstname=' . urlencode($firstname) . '" class="text-light">See Comments</a></button></td>
                </tr>';
            }
          }
