...
$sql = "SELECT id, title, description, subject, level, file_path FROM activities";
  ...
  <div class="container-wrapper">
    ...
    <div class="content">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="activity-card">
                  <div class="activity-title"><?php echo $activityTitle; ?></div>
                    <div class="activity-description"><?php echo $activityDescription; ?></div>
                      <div class="activity-subject"><?php echo $activitySubject; ?></div>
                      <div class="activity-level"><?php echo $activityLevel; ?></div>
                      <a href="<?php echo $activityFilePath; ?>" download class="btn btn-primary">Download</a>
                      <a href="../../crud/editact.php?id=<?php echo $activityId; ?>" class="btn btn-primary">Edit</a>
                      <form method="post" action="../../crud/deleteactivity.php" onsubmit="return confirm('Are you sure you want to delete this record?')">
                        <input type="hidden" name="activities" value="activities"> <!-- Use the correct table name here -->
                        <input type="hidden" name="record_id" value="<?php echo $activityId; ?>">
      ...
      <div class="activity-upload-btn">
        <a href="uploadactivities.php" class="btn btn-primary">Upload Activity</a>
    </div>
  </div>
